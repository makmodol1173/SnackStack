...
<div class="mx-8">
    <div class="flex flex-row">
        <div class="flex flex-row space-x-4 flex-grow">
            ...
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/Indian" class="sort-font">Indian</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/Italian" class="sort-font">Italian</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/Bangladeshi" class="sort-font">Bangladeshi</a>
            </div>
        </div>
        <div class="flex flex-row space-x-4 flex-grow justify-end">
            <span class="font-weight-bold sort-font my-auto"> Order By :</span>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="{{url()->current().'?asc=true'}}" class="sort-font">Lowest Price</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="{{url()->current().'?asc=false'}}" class="sort-font">Highest Price</a>
            </div>
        </div>
    </div>
</div>
